...
public class TinyRedstonePieceItem extends MredstonesModElements.ModElement {
	@ObjectHolder("mredstones:tiny_redstone_piece")
	public static final Item block = null;
	public TinyRedstonePieceItem(MredstonesModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tiny_redstone_piece");
		}
