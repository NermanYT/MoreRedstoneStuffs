...
package net.mredstones.entity;

import net.mredstones.procedures.RedstonePigEntityDiesProcedure;
import net.mredstones.item.TinyRedstonePieceItem;
import net.mredstones.entity.renderer.RedstonePigRenderer;
...
public class RedstonePigEntity extends MredstonesModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 0.9f)).build("redstone_pig").setRegistryName("redstone_pig");
	public RedstonePigEntity(MredstonesModElements instance) {
		super(instance, 7);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RedstonePigRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092544, -11513776, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("redstone_pig_spawn_egg"));
	}
	...
	public static class CustomEntity extends PigEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TinyRedstonePieceItem.block, (int) (1)));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				RedstonePigEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
